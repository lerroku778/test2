      ...
      fragmentShader: /* glsl */`
        ...
        void main(){
          ...
          if (drunk > 0.001) {
            ...
            vec2 go = drunk * dir * (0.014 + 0.01 * sin(t * 1.7) + 0.004 * sin(t * 4.1));
            vec3 ghost = texture2D(tDiffuse, uv + go).rgb + texture2D(tDiffuse, uv - go * 0.5).rgb;
            col = mix(col, ghost * 0.5, clamp(drunk * 0.5, 0.0, 0.5));
          }
